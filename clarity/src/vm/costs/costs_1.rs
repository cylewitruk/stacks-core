...
impl CostValues for Costs1 {
    ...
    fn cost_analysis_visit(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
    ...
    fn cost_analysis_option_cons(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
        Ok(ExecutionCost::runtime(1000))
    }

    fn cost_analysis_option_check(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_analysis_lookup_function(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_analysis_lookup_variable_const(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
        Ok(ExecutionCost::runtime(1000))
    }
    ...
    fn cost_lookup_function(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
        Ok(ExecutionCost::runtime(1000))
    }

    fn cost_bind_name(_n: u64) -> Result<ExecutionCost, VmExecutionError> {
        Ok(ExecutionCost::runtime(1000))
    }
